...
for i in range (len(cipherList)):
    xStringOne = xor(cipherOne, cipherList[i])
    print i
    print xStringOne
...
for i in range (len(cipherList)):
    xStringTwo = xor(cipherTwo, cipherList[i])
    print i
    print xStringTwo
...
for i in range (len(cipherList)):
    xStringThree = xor(cipherThree, cipherList[i])
    print i
    print xStringThree
...
for i in range (len(cipherList)):
    xStringFour = xor(cipherFour, cipherList[i])
    print i
    print xStringFour
...
for i in range (len(cipherList)):
    xStringFive = xor(cipherFive, cipherList[i])
    print i
    print xStringFive
...
for i in range (len(cipherList)):
    xStringSix = xor(cipherSix, cipherList[i])
    print i
    print xStringSix

print "Seventh cipher"

for i in range (len(cipherList)):
    xStringSeven = xor(cipherSeven, cipherList[i])
    print i
    print xStringSeven
...
for i in range (len(cipherList)):
    xStringEight = xor(cipherEight, cipherList[i])
    print i
    print xStringEight
...
for i in range (len(cipherList)):
    xStringNine = xor(cipherNine, cipherList[i])
    print i
    print xStringNine
...
for i in range(len(cipherList)):
    slideOne = slide(xStringOne, (len(cipherList[i])), "the")
    print slideOne
